...
import heroImg from "../public/img/bravont/paragon.png";
import Navbar from "../components/navbar";
import MailingList from "./MailingList";

const Hero = () => {
  return (
    <div className="h-screen bg-cover bg-[url('/img/bravont/wraith2.jpeg')]">
      <div className="h-screen bg-cover bg-opacity-20 bg-black ">
        <Navbar />
        <Container className="flex flex-wrap w-full lg:w-3/4 h-full">
          <div className="flex items-center w-full lg:w-3/4">
            <div className="max-w-2xl mb-8">
              ...
              <MailingList bgColor="indigo-600" textColor="white" />
